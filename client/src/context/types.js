...
export const GET_ACTORS_SUCCESS = "GET_DOCTORS_SUCCESS";
export const GET_ACTORS_FAILURE = "GET_DOCTORS_FAILURE";
...
export const PATIENT_EXISTS_SUCCESS = "PATIENT_EXISTS_SUCCESS";
export const PATIENT_EXISTS_FAILURE = "PATIENT_EXISTS_FAILURE";
export const CLEAR_PATIENT_EXISTS = "CLEAR_PATIENT_EXISTS";
...
export const GET_MEDICINE_STOCK_SUCCESS = "GET_MEDICINE_STOCK_SUCCESS";
export const GET_MEDICINE_STOCK_FAILURE = "GET_MEDICINE_STOCK_FAILURE";
...
export const GET_ALL_MEDICINE_DETAILS_FAILURE =
  "GET_ALL_MEDICINE_DETAILS_FAILURE";
export const GET_ALL_MEDICINE_DETAILS_SUCCESS =
  "GET_ALL_MEDICINE_DETAILS_SUCCESS";
...
export const GET_PRESCRIPTION_BY_ID_FAILURE = "GET_PRESCRIPTION_BY_ID_FAILURE";
export const GET_PRESCRIPTION_BY_ID_SUCCESS = "GET_PRESCRIPTION_BY_ID_SUCCESS";
